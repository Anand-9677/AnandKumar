...
function Skills() {
  return (
    <section id='skills' className='py-24 pb-24 px-[6vw] md:px-[6vw] lg:px-[14vw] font-sans bg-skills-gradient clip-path-custom'>
      <div className='text-center mb-8'>
        <h2 className='text-3xl sm:text-4xl text-white font-bold'>SKILLS</h2>
        <div className='w-24 h-1 bg-[#6884f5] mx-auto mt-2'></div>
      ...
      <div className='flex flex-wrap gap-1 lg:gap-5 py-10 justify-between'>
        {SkillsInfo.map((category)=>(
          <div 
          key={category.title}
          className='bg-gray-900 backdrop-blur-md px-6 sm:px-6 py-8 sm:py-6 mb-10 w-full sm:w-[48%] rounded-2xl border border-white shadow-[0_0_20px_1px_rgba(37,99,235,0.6)]'
          >
